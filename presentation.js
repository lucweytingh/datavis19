...
var options = {'label_prepend': 'Amount of rows per country', 'legend': 'true', 'library': {'legend': {'position': 'left'}, 'backgroundColor': {'fill': 'transparent'}, 'datalessRegionColor': '#f5f5f5', 'defaultColor': '#f5f5f5'}};
